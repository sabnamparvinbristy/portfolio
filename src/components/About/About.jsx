...
const About = () => {
  return (
    <div className="relative z-0">
      ...
      <section
        id="about"
        className="py-24 px-[7vw] bg-gradient-to-br from-[#050414] via-[#0f0c29] to-[#1f3a56] text-white clip-path-custom-4 relative z-10"
      >
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12">
          ...
          <div className="md:w-1/2 text-center md:text-left">
            ...
            <p
              className="text-base sm:text-lg text-gray-400 leading-relaxed mb-8 font-[Dancing Script] font-bold"
              style={{ fontFamily: "'Dancing Script', cursive" }}
            >
              " I’m a full-stack developer in the making, passionate about
              software development and driven by curiosity. From Python to
              ML/AI, I enjoy solving problems and building things that matter.
              With each project, I grow — and I’m always ready to learn,
